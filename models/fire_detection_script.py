...
def predict_image_func(video_source):
    ...
    while cap.isOpened():
        ...
        if alert_count == 20:
            ...
            output_filename = f"C:/Users/Roman/PycharmProjects/Video Analytics Industrial Safety/alert_fire/alert_{video_count}.mp4"
            ...
            for frame in frames:
                out.write(frame)
            out.release()
            with open(f"C:/Users/Roman/PycharmProjects/Video Analytics Industrial Safety/alert_fire/alert_{video_count}.mp4", "rb") as f:
                cos.upload_fileobj(
                    f,
                    credentials["bucket"],
            ...
            r = requests.post(
                "https://4f74-188-163-102-99.ngrok-free.app",
                json=final_data,
            )
            print(r.text)
            video_count += 1
